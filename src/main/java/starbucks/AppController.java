...
public class AppController implements IApp {
   ...
   /** Enums for Screen Types */
    public enum SCREENS {
        MY_CARDS_MAIN, MY_CARDS_PAY,MY_CARDS_OPTIONS,MY_CARDS_MORE_OPTIONS,ADD_CARD,SETTINGS,STORE
    }
   ...
   private static AppController theController = null;
     ...
     */
    public void startUp() {
      System.err.println("APPCONTROLLER: STARTUP");
      ...
      mycardsMoreOptions=new LeftDecorator(new MyCardsMoreOptions());
